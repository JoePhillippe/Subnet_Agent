...
@app.route('/get_question_by_number', methods=['POST'])
...
if __name__ == '__main__':
    print("=" * 60)
    print("IPv4 Networking Tutor Starting...")
    print("=" * 60)
    print("Teaching: Binary, IP Classification, Subnetting")
    print("Powered by Claude API")
    print("Canvas Question Numbers: 1-10 for each quiz")
