...
@app.route('/select_part', methods=['POST'])
def select_part():
    data = request.json
    problem_num = data.get('problem_number')
    part = data.get('part')
...
@app.route('/matrix/<address_class>')
...
if __name__ == '__main__':
    print("=" * 70)
    print("Custom Subnet Mask Tutor - Professor Bodden's Methodology")
    print("=" * 70)
    print("6 Problems: 2 Class C, 2 Class B, 2 Class A")
    print("10 Parts per problem")
    print("Progressive hint system (5 attempts)")
    print("Powered by Claude Sonnet 4")
    print("=" * 70)
    
    if not os.environ.get("ANTHROPIC_API_KEY"):
        print("⚠️  WARNING: ANTHROPIC_API_KEY not found!")
        print("Set it in environment variables or GitHub Codespaces Secrets")
    else:
        print("✅ API Key: Found!")
