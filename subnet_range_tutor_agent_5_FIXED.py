...
@app.route('/next_part', methods=['POST'])
def next_part():
    """Move to next part"""
    current_part = session.get('current_part', 'part1')
...
if __name__ == '__main__':
    print("=" * 70)
    print("Subnet Range Tutor - Progressive 5-Level Mentoring")
    print("=" * 70)
    print("6 Problems: 2 Class C, 2 Class B, 2 Class A")
    print("12 Parts per problem with subnet range calculations")
    print("5-Level Progressive Mentoring System")
    print("Powered by Claude Sonnet 4")
    print("=" * 70)
    
    if not os.environ.get("ANTHROPIC_API_KEY"):
        print("⚠️  WARNING: ANTHROPIC_API_KEY not found!")
        print("Set it in environment variables")
    else:
        print("✅ API Key: Found!")
