...
@app.route('/get_problem/<int:problem_num>')
...
@app.route('/get_part/<int:problem_num>/<int:part_num>')
...
if __name__ == '__main__':
    print("=" * 70)
    print("VLSM Tutor - Final Version for Spyder IDE")
    print("=" * 70)
    print("3 Problems with Visual Diagrams:")
    print("  • Problem 1: Small Business (4 parts)")
    print("  • Problem 2: Corporate Network (5 parts)")
    print("  • Problem 3: Multi-City Enterprise (6 parts)")
    print()
    print("Features:")
    print("  ✓ Visual network diagrams (colored boxes)")
    print("  ✓ Sequential part progression")
    print("  ✓ Continue button (student controlled)")
    print("  ✓ 5-level progressive hints")
    print("  ✓ Answer validation")
    print("=" * 70)
    
    if not os.environ.get("ANTHROPIC_API_KEY"):
        print("⚠️  Set ANTHROPIC_API_KEY in Spyder console:")
        print("   import os")
    ...
    print("Open browser to: http://localhost:5004")
    print("=" * 70)
